...
REM Help Viewer 1.0
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale ja-jp /uninstall /silent /vendor "Vendor Name" /productName "ClangNet" /mediaBookList "A Sandcastle Documented Class Library"
...
REM Help Viewer 2.x
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale ja-jp /wait 0 /operation uninstall /vendor "Vendor Name" /productName "ClangNet" /bookList "A Sandcastle Documented Class Library"
